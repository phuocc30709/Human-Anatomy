...
export const quizzData: { [key: string]: QuizzData[] } = {
  easy: [
    {
      image: require('../../assets/image/easy/ques1.png'),
    ...
    {
      image: require('../../assets/image/easy/ques2.png'),
    ...
    {
      image: require('../../assets/image/easy/ques3.png'),
    ...
    {
      image: require('../../assets/image/easy/ques8.png'),
    ...
    {
      image: require('../../assets/image/easy/ques9.png'),
    ...
    {
      image: require('../../assets/image/easy/ques10.png'),
  ...
  medium: [
    ...
    {
      image: require('../../assets/image/medium/ques4.png'),
    ...
    {
      image: require('../../assets/image/medium/ques5.png'),
    ...
    {
      image: require('../../assets/image/medium/ques6.png'),
    ...
    {
      image: require('../../assets/image/medium/ques7.png'),
    ...
    {
      image: require('../../assets/image/medium/ques8.png'),
    ...
    {
      image: require('../../assets/image/medium/ques9.png'),
      ques: "Question 9: How many skeletal muscles in the human body?",
      choose: ['400', '600', '800'],
      ans: 1
    },
    {
      image: require('../../assets/image/medium/ques10.png'),
  ...
  hard: [
    {
      image: require('../../assets/image/hard/ques1.png'),
    ...
    {
      image: require('../../assets/image/hard/ques2.png'),
      ques: "Question 2: Where do most nerves start?",
      choose: ['Heart', 'Nerves cells', 'Spinal cord'],
      ans: 2
    },
    {
      image: require('../../assets/image/hard/ques3.png'),
    ...
    {
      image: require('../../assets/image/hard/ques4.png'),
    ...
    {
      image: require('../../assets/image/hard/ques9.png'),
    ...
    {
      image: require('../../assets/image/hard/ques10.png'),
